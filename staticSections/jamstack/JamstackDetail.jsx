      ...
      <section className={styles.sectionContainer}>
        ...
        <main className={styles.sectionInner}>
          <div className={styles.sectionTitle}>
            <h2 className={styles.h2}>Jamstackとはなにか</h2>
          </div>
        ...
        <main className={styles.sectionInner}>
          <div className={styles.sectionTitle}>
            <h2 className={styles.h2}>図で見る、従来との違い</h2>
          </div>
          <p>
        ...
        <main className={styles.sectionInner}>
          <div className={styles.sectionTitle}>
            <h2 className={styles.h2}>Jamstackを導入すべきか</h2>
          </div>
        ...
        <main className={styles.sectionInner}>
          <div className={styles.sectionTitle}>
            <h2 className={styles.h2}>Jamstackなホームーページを作るなら</h2>
          </div>
